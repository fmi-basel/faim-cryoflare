...
rln_inputstar=""
rln_header+=(micrographs)
RELION_WRITE $destination_path $rln_jobtype $rln_jobid $rln_alias $rln_nodetype $rln_starname $rln_inputstar $rln_header micrographs_mc2/${short_name}.mrc
